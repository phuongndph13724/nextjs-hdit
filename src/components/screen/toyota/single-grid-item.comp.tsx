...
const SingleGridItem = ({ item }: { item: any }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-white shadow-1 min-h-[270px] mb-4">
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white shadow-sm hover:text-blue"
          >
            <svg
          ...
          <button
            ...
            className="inline-flex font-medium text-custom-sm py-[7px] px-5 rounded-[5px] bg-blue text-white bg-blue-500 ease-out duration-200 hover:bg-blue-dark"
          >
            Liên hệ
          </button>
          ...
          <button
            ...
            id="favOne"
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark shadow-sm  bg-white hover:text-blue"
          >
            <svg
              className="fill-current"
              width="16"
      ...
      <h3 className="font-medium text-dark ease-out duration-200 hover:text-blue-500 mb-1.5">
        <Link href="/shop-details"> {item.title} </Link>
      </h3>
      <p className="block antialiased font-sans text-md font-normal leading-relaxed text-inherit mb-4 !text-gray-500">
        {item.description}
      </p>
