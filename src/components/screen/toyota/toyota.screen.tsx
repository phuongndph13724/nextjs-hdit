...
import shopData from "@/utils/data-example/shopData";
import React, { useEffect, useState } from "react";
import { index } from "@material-tailwind/react/types/components/select";
import SingleGridItem from "./single-grid-item.comp";
import SingleListItem from "./single-list-item.comp";
import ColorsDropdwon from "./colors-dropdwon.comp";
import CategoryDropdown from "./category-dropdown.comp";
import PriceDropdown from "./price-dropdown.comp";
...
const ToyotaScreen = () => {
  ...
  return (
    <div className="flex flex-col justify-between px-8">
      <Navbar />
      <div className="">
        <Breadcrumb title={"Danh sách sản phẩm của Toyota"} pages={[]} />
        <section className="overflow-hidden relative pb-20 pt-6 bg-[#f3f4f6]">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex gap-8">
              ...
              <div
                ...
                className={`sidebar-content fixed xl:z-1 left-0 top-0 xl:translate-x-0 xl:static max-w-[310px] xl:max-w-[270px] w-full ease-out duration-200 ${
                  productSidebar
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="bg-white shadow-1 rounded-lg py-4 px-5">
                      <div className="flex items-center justify-between">
                        <p>Bộ lọc:</p>
                        <button className="text-blue-400">Xóa tất cả</button>
                      </div>
                    </div>
              ...
              <div className="xl:max-w-[870px] w-full">
                <div className="rounded-lg bg-white shadow-1 pl-3 pr-2.5 py-2.5 mb-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                      <p>
                        Hiển thị{" "}
                        <span className="text-dark">9 trong số 50</span> sản
                        phẩm
                      </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2.5">
                      <button
                        ...
                        } flex items-center justify-center w-10 h-9 rounded-[5px] border ease-out duration-200 hover:bg-blue-500 hover:border-blue-500 hover:text-white`}
                      >
                        <svg
                          className="fill-current"
                          width="18"
                ...
                <div
                  className={`${
                    productStyle === "grid"
                      ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-9"
                      : "flex flex-col gap-8"
                  }`}
                >
                  {shopData.map((item: any, key: index) =>
                    productStyle === "grid" ? (
                  ...
                  <div className="bg-white shadow-1 rounded-md p-2">
                    <ul className="flex items-center">
                      ...
                      <li>
                        <a
                          href="#"
                          className="flex py-1.5 px-3.5 duration-200 rounded-[3px] bg-blue-500 text-white hover:text-white hover:bg-blue-500"
                        >
                          1
                        </a>
                      </li>
                      ...
                      <li>
                        <a
                          href="#"
                          className="flex py-1.5 px-3.5 duration-200 rounded-[3px] hover:text-white hover:bg-blue-500"
                        >
                          2
                        </a>
                      </li>
