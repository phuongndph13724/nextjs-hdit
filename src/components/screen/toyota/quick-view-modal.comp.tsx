...
const QuickViewModal = () => {
  ...
  return (
    <div
      style={isModalOpen ? { zIndex: 99999999 } : {}}
      className={`${
        isModalOpen ? "" : "hidden"
      } fixed top-0 left-0 h-screen w-screen overflow-y-auto no-scrollbar sm:py-20 xl:py-25 2xl:py-[230px] bg-gray-600/70 sm:px-8 px-4 py-5`}
    >
      <div className="flex items-center justify-center ">
        <div className="w-full max-w-[1100px] rounded-xl shadow-xl bg-white p-8 relative modal-content">
          <button
            onClick={() => closeModal()}
            ...
            <div className="max-w-[526px] w-full">
              <div className="flex gap-5">
                <div className="flex flex-col gap-5">
                  {product.imgs.thumbnails?.map((img: any, key: number) => (
                    <button
            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-4">
                <button
                  ...
                  className={`inline-flex font-medium text-white bg-blue-500 py-3 px-7 rounded-md ease-out duration-200 hover:bg-blue-dark
                  `}
                >
                  Liên hệ ngay
                </button>
                ...
                <button
                  className={`inline-flex items-center gap-2 font-medium text-white bg-slate-900 py-3 px-6 rounded-md ease-out duration-200 hover:bg-opacity-95 `}
                >
                  <svg
                    className="fill-current"
                    width="20"
